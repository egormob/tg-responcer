...
* `/broadcast edit <jobId> <текст>` — обновляет сообщение активной рассылки, если оно отправлено не более 48 часов назад.
* `/broadcast cancel <jobId>` — удаляет сообщение рассылки в поддерживаемых чатах до истечения 48 часов после отправки.
