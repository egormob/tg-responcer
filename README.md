...
* `/broadcast` — двухшаговая рассылка: бот проверяет whitelisting администратора, запрашивает аудиторию (`/everybody` или список user_id/username, дубликаты убираются) и только после этого принимает текст сообщения (≤4096 символов) для выбранных получателей из D1.
