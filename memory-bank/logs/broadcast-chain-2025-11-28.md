...
- Все новые экспериментальные режимы рассылки обязаны сохранять или явно переопределять глобальный лимитер 28 RPS + джиттер (`BROADCAST_MAX_RPS`/`BROADCAST_RATE_JITTER_RATIO`); внедрено 2025-11-21, коммит 4f502e0.
