...
## 2025-11-10 — Старт задач М8 (операционный аудит)
- Зафиксировано начало работ по подпунктам М8: документирование контуров HTTP и Telegram для рассылок, обновление памяток по токенам/флагам и подготовка критериев приёмки аудита.
- Обновлены артефакты: `RoadMap.md` (подраздел М8) и `memory-bank/operations/broadcast-operations.md`.
- Следующие шаги: подготовить чек-листы запусков `/admin/broadcast`, внедрить smoke-тесты для Telegram-команд и синхронизировать прогресс с журналом рассылок.
