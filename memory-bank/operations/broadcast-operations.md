...
- Известная проблема для следующего шага: при попытке отправить текст, превышающий лимит Telegram, бот повторяет предупреждение дважды. Требуется устранить дублирование до закрытия майлстоуна рассылки.
