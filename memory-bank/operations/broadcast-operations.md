...
- Диалог состоит из двух шагов:
  ...
  2. После выбора аудитории бот пишет «Шаг 2. Пришлите текст для N получателей… /send или /cancel». Только этот текст уходит выбранным адресатам.
...
3. После выбора аудитории бот пишет «Шаг 2. Пришлите текст для N получателей… /send или /cancel». `/cancel` завершают сценарий без отправки, `/send <текст>` или обычный текст (≤4096 символов) уходят только выбранным получателям.
