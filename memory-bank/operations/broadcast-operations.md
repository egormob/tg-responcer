...
3. После выбора аудитории бот пишет «Шаг 2. Пришлите текст для N получателей, /cancel для отмены». `/cancel` завершают сценарий без отправки, текст (≤4090 символов) уходит только выбранным получателям.
...
- Длина сообщения — до 4090 символов. Более длинные тексты нужно разделять вручную.
...
- Протестировать граничные значения: пустой текст, текст из 4090 символов.
3. **Мониторинг**
