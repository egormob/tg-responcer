...
- Модель рассылки: мгновенное текстовое сообщение без форматирования, вложений, фильтрации и отложенной отправки. На этапе MVP сегментация отключена: рассылка всегда уходит всем из `BROADCAST_RECIPIENTS`, фильтры аудиторий будут включены отдельной задачей.
