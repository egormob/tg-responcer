...
## Ретест 2025-11-16
- Внешний прогон self-test зафиксировал повторение ошибки `openai: missing diagnostic marker` и `telegram: Bad Request: chat not found` после пинга. Подробный журнал шагов и карта диагностики — в [external-checks/retest-2025-11-16.md](../external-checks/retest-2025-11-16.md).
