...
## Best practices
1. **Единая нормализация.** Храни payload в исходном виде (`users.utm_source`) и при необходимости раскладывай части уже в аналитике или вспомогательных витринах.
