...
4. Жёсткие проверки окружения и усиление self-test.
  ...
  - **Статус:** ⏳/🚧 Шаг переоткрыт: требуется прогон `/admin/selftest` против no-op AI, чтобы подтвердить корректность заглушек и отчёта об ошибках; текущие проверки OpenAI/Telegram остаются в силе.
