...
- **Gate-чек:**
  - **Статус:** 🚧 М7 содержит незакрытые шаги (`/admin/selftest` на no-op AI); М8 остаётся в режиме ожидания до закрытия gate-чека и повторного запуска `npm run check:roadmap`.
