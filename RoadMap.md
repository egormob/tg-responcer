...
## Журнал прогресса
- 2025-11-02: Проверка типов `npx tsc --noEmit` завершилась ошибкой TS5110 из-за несоответствия `module` и `moduleResolution`; лог сохранён в `logs/tsc-2025-11-02.txt`, задача-торможение по проверкам остаётся активной до устранения.
