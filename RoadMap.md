...
5. Устранение паузы между индикатором typing и ответом.
   ...
   - **Статус:** ⏳ Новая задача (см. `memory-bank/issues/typing-indicator-delay.md`); требуется собрать тайминги и обновить менеджер `createTypingIndicator` максимально эргономичным и эффективным способом.
