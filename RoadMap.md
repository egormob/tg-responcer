...
**Зависимости:** завершены майлстоуны 1–9.
...
5. Фиксируй в журнале прогресса рядом с временем шага его номер и номер текущего майлстоуна.
...
7. Убедиться в чистоте истории: `git status`, `git diff --check`, разрешение конфликтов фиксируется в журнале.
8. Закоммитить изменения, подготовить PR через `make_pr`.
9. Отчёт о выполнении задачи всегда предоставляй на русском языке.
10. В отчёте указывай прогресс-бар с процентом пройденного пути, целью ближайшего майлстоуна и количеством задач до него.
