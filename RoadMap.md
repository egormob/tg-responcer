...
10. Закоммитить изменения, подготовить PR через `make_pr`.
11. Отчёт о выполнении задачи всегда предоставляй на русском языке.
12. В отчёте указывай прогресс-бар с процентом пройденного пути, целью ближайшего майлстоуна и количеством задач до него, а также количеством шагов до ближайшей проверки.
